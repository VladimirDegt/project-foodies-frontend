...
const ServerError = () => {
  return (
    <div className={styles.main_error_page}>
      <svg
      ...
      >
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g>
            ...
            <g className={styles.full_torradeira}>
            ...
            <g className={styles.raios} stroke="#fdba55" strokeLinecap="round" strokeWidth="1.8">
              <path
      ...
      <h2 className={styles.error_subtitle}>Have you tried turning it off and on again?</h2>
    </div>
  );
};
